...
public:
	...
	Vertex* getPointArray () const { return PointArray; }
	void setPointArray(Vertex* PA) {PointArray = PA; }
	virtual void setPointArray(const Matrix4x4&, Material* mat) = 0;
protected:
	Vertex* PointArray;
	Point3D center;
...
public:
	...
	void setPointArray(const Matrix4x4& modelToWorld, Material* mat);
};
